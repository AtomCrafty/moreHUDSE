...
#undef GetModuleHandle
        ...
        const auto dllHandle = WinAPI::GetModuleHandle(SERVER_PLUGIN_NAME);
        const auto getInterfaceProc = reinterpret_cast<GetInterfaceProc>(WinAPI::GetProcAddress(dllHandle, "GetCompletionistInterfaceV20"));
